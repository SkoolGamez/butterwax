  ...
  [356],
  {
    1526: function (t, e, i) {
      ...
      function h({ children: t, isPresent: e }) {
        ...
        `),
          ...
          r.createElement(
            u,
            { isPresent: e, childRef: n, sizeRef: s },
            r.cloneElement(t, { ref: n })
          )
        );
      }
      let c = ({
        ...
        return (
          ...
          "popLayout" === u && (t = r.createElement(h, { isPresent: i }, t)),
          r.createElement(a.O.Provider, { value: m }, t)
        );
      };
      function d() {
        return new Map();
        ...
        g = ({
          ...
          let g =
              ...
              (function () {
                let t = s(),
                  ...
                  a = (0, r.useCallback)(() => o.Wi.postRender(n), [n]);
                return [a, e];
              })()[0],
            v = s(),
            y = (function (t) {
          ...
          return (
              ...
              o ||
                ((o = r.createElement(
                  c,
                  {
                    ...
                    isPresent: !1,
                    onExitComplete: () => {
                      w.delete(i), P.delete(i);
                      let t = b.current.findIndex((t) => t.key === i);
                      if ((b.current.splice(t, 1), !P.size)) {
            ...
            r.createElement(
              r.Fragment,
              null,
              P.size ? x : x.map((t) => (0, r.cloneElement)(t))
            )
          );
        };
    },
    ...
    7745: function (t, e, i) {
      ...
      let er = ei(0.42, 0, 1, 1),
        ...
        eA = {
          test: (t) => eb.test(t) || ew.test(t) || eT.test(t),
          parse: (t) =>
            eb.test(t) ? eb.parse(t) : eT.test(t) ? eT.parse(t) : ew.parse(t),
          transform: (t) =>
            X(t)
              ? t
      ...
      let ek = (t, e) => {
        ...
        eL = { regex: H, countKey: "Colors", token: "${c}", parse: eA.parse },
        ej = { regex: Z, countKey: "Numbers", token: "${n}", parse: W.parse };
      ...
      let ez = (t, e) => {
        ...
        eZ = (t, e) => {
          let i = { ...t, ...e },
            r = {};
          for (let n in i)
            void 0 !== t[n] && void 0 !== e[n] && (r[n] = eN(t[n], e[n]));
          return (t) => {
      ...
      function e4({
        ...
        let T = "idle",
          ...
          S = null,
          V = null;
        null === w.calculatedDuration && s && (w.calculatedDuration = e3(w));
        ...
        let B = {
          ...
          get duration() {
            let t =
              null === w.calculatedDuration ? e3(w) : w.calculatedDuration;
            return t4(t);
          },
          get speed() {
            return y;
      ...
      function iR(t, e, { delay: i = 0, transitionOverride: r, type: n } = {}) {
        ...
        for (let e in a) {
          ...
          if (window.HandoffAppearAnimations && !r.hasAnimated) {
            let i = t.getProps()[t2];
            i && (o.elapsed = window.HandoffAppearAnimations(i, e, r, tD.Wi));
          }
          r.start(
      ...
      let rx = {
        correct: (t, e) => {
          ...
          let i = ry(t, e.target.x),
            r = ry(t, e.target.y);
          return `${i}% ${r}%`;
        },
      };
      class rP extends o.Component {
        componentDidMount() {
          let {
              visualElement: t,
              layoutGroup: e,
      ...
      function rj(t, e, [i, r, n], s, o) {
        !(function (t, e = 0, i = 1, r = 0.5, n, s = t, o = t) {
          ...
          t === s && (a -= e),
            (t.min = rL(t.min, e, i, a, n)),
            (t.max = rL(t.max, e, i, a, n));
        })(t, e[i], e[r], e[n], e.scale, s, o);
      }
      let rF = ["x", "scaleX", "originX"],
        rB = ["y", "scaleY", "originY"];
      function rO(t, e, i, r) {
        rj(t.x, e, rF, i ? i.x : void 0, r ? r.x : void 0),
          rj(t.y, e, rB, i ? i.y : void 0, r ? r.y : void 0);
      }
      function rI(t) {
      ...
      function rq({
        ...
        return class {
            ...
            (this.id = rX++),
              ...
              (this.updateProjection = () => {
                (rG.totalNodes =
                  ...
                  window.MotionDebug && window.MotionDebug.record(rG);
              }),
              (this.hasProjected = !1),
              (this.isVisible = !0),
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new iw()),
              ...
              t(e, () => {
                (this.root.updateBlockedByResize = !0),
                  ...
                  rv.hasAnimatedSinceResize &&
                    ((rv.hasAnimatedSinceResize = !1), this.nodes.forEach(r3));
              });
            }
          ...
          startUpdate() {
            !this.isUpdateBlocked() &&
              ((this.isUpdating = !0),
              this.nodes && this.nodes.forEach(r9),
              this.animationId++);
          }
          ...
          update() {
            ...
            this.isUpdating || this.nodes.forEach(r5),
              (this.isUpdating = !1),
          ...
          clearAllSnapshots() {
            this.nodes.forEach(r0), this.sharedNodes.forEach(r7);
          }
          ...
          resetTransform() {
            ...
            let t = this.isLayoutDirty || this.shouldResetTransform,
              e = this.projectionDelta && !rU(this.projectionDelta),
          ...
          removeTransform(t) {
            ...
            return rt(this.latestValues) && rO(e, this.latestValues), e;
          }
          setTargetDelta(t) {
            (this.targetDelta = t),
                ...
                h &&
                  ...
                  (function (t, e, i, r, n, s) {
                    ...
                    for (let n = 0; n < rA; n++) {
                      ...
                      o || (o = 0), a || (a = 0);
                      let l = 0 === o || 0 === a || rV(o) === rV(a);
                      l
                        ? ((t[s] = Math.max(eS(rS(o), rS(a), r), 0)),
          ...
          applyTransformsToTarget() {
            ...
            if (e && i && r) {
              if (
                ...
                i = this.target || i6();
                let e = iH(this.layout.layoutBox.x);
                (i.x.min = t.target.x.min), (i.x.max = i.x.min + e);
                let r = iH(this.layout.layoutBox.y);
      ...
      let ni = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        ...
        nn = nr("applewebkit/") && !nr("chrome/") ? Math.round : tG.Z;
      function ns(t) {
      ...
      function no(t, e, i) {
        return (
          "position" === t ||
          ("preserve-aspect" === t && !iY(r$(e), r$(i), 0.2))
        );
      }
      let na = rq({
      ...
      (nP.translateX = nP.x), (nP.translateY = nP.y);
      let nb = (t, e, i) => {
        ...
        nT = (t, e, i, r) => {
          ...
          return (
            ...
            (n = e),
            (s = r),
            nm(n) ? nw(t, n, i, s) : { target: n, transitionEnd: s }
          );
        },
        nA = { current: null },
        nS = { current: !1 },
      ...
      class nk {
        ...
        mount(t) {
          (this.current = t),
            ...
            (this.shouldReduceMotion =
              ...
              ("always" === this.reducedMotionConfig || nA.current)),
            this.parent && this.parent.children.add(this),
            this.update(this.props, this.presenceContext);
        }
        unmount() {
          for (let t in (nV.delete(this.current),
        ...
        on(t, e) {
          return (
            this.events[t] || (this.events[t] = new iw()), this.events[t].add(e)
          );
        }
        notify(t, ...e) {
      ...
      let nF = (t, e) =>
        ...
        nB = {
          ...
          layout: { ProjectionNode: nu, MeasureLayout: rb },
        },
        nO = (function (t) {
          function e(e, i = {}) {
            return (function ({
